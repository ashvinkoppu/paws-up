...
const QUESTIONS = [
  {
    ...
    options: ["8 hours", "12-16 hours", "20 hours", "6 hours"],
    correct: 1,
  },
  {
    question: "What is a group of kittens called?",
    options: ["A pack", "A kindle", "A flock", "A herd"],
    correct: 1,
  },
  {
    question: "Which dog breed is the smallest?",
    options: ["Pomeranian", "Yorkie", "Chihuahua", "Dachshund"],
    correct: 2,
  },
  {
  ...
  {
    question: "What is a rabbit's favorite time of day?",
    options: ["Noon", "Midnight", "Dawn & dusk", "Afternoon"],
    correct: 2,
  },
  {
    question: "Which animal can rotate its ears 180°?",
    options: ["Dog", "Cat", "Hamster", "Rabbit"],
    correct: 3,
  },
  {
    question: "How fast can a hamster run?",
    options: ["2 mph", "5 mph", "8 mph", "12 mph"],
    correct: 2,
  },
  {
    question: "What is a baby rabbit called?",
    options: ["Pup", "Kit", "Cub", "Joey"],
    correct: 1,
  },
  {
  ...
  {
    question: "Which pet can be trained to use a litter box?",
    options: ["Only cats", "Cats & rabbits", "Only dogs", "All pets"],
    correct: 1,
  },
];
    ...
    setTimeout(() => {
      if (currentQuestion + 1 >= shuffledQuestions.length) {
        ...
        if (newCorrectCount >= 3) {
          ...
          const reward =
            newCorrectCount === 5 ? 15 : newCorrectCount === 4 ? 10 : 6;
          onWin(reward);
    ...
    <div className="space-y-5">
      ...
      <div className="h-2.5 bg-accent/30 rounded-full overflow-hidden">
        <div
          ...
          style={{
            width: `${((currentQuestion + (showResult ? 1 : 0)) / shuffledQuestions.length) * 100}%`,
          }}
        />
      </div>
      ...
      <p className="text-sm text-muted-foreground text-center bg-accent/30 p-3 rounded-xl">
        Answer pet trivia! Get{" "}
        <span className="font-semibold text-foreground">3+ correct</span> to
        earn rewards.
      </p>
    </div>
  );
