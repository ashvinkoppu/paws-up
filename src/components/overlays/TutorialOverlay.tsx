...
const TUTORIAL_STEPS: TutorialStep[] = [
  {
    ...
    title: "Your Pet",
    description:
      "This is your new companion! Watch their mood, level, and stats here. Keep all stats above 30% to keep them healthy and happy.",
  ...
  },
  {
    ...
    title: "Care Actions",
    description:
      "Use these buttons to feed, play, clean, rest, and visit the vet. Each action uses items from your inventory, so stock up at the shop first!",
  ...
  },
  {
    ...
    title: "Shop",
    description:
      "Buy food, toys, cleaning supplies, and more to care for your pet. Manage your budget wisely - you start with $100!",
  ...
  },
  {
    ...
    title: "Mini Games",
    description:
      "Play fun mini games to earn money and XP. The better you score, the more you earn to spend on your pet!",
  ...
  },
  {
    ...
    title: "Daily Tasks",
    description:
      "Complete daily tasks to earn bonus XP and money. New tasks appear each day - some are timed, so act fast!",
  ...
  },
  {
    ...
    description:
      "Track your spending and income here. Keep an eye on your weekly budget to avoid running out of money!",
  ...
  },
  {
    ...
    description:
      "Unlock achievements by reaching milestones and browse your collectibles here. Each achievement earns you bonus money - collect them all!",
    ...
    switch (step.position) {
      ...
      case "right":
        return {
          ...
          left: Math.min(
            targetRect.right + padding + tooltipMargin,
            window.innerWidth - tooltipWidth - 16,
          ),
          width: tooltipWidth,
        };
